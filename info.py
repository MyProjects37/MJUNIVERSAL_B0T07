...
# Bot information
SESSION = environ.get('SESSION', 'MJUniversalbot')
...
PICS = (environ.get('PICS', 'https://graph.org/file/e5805cf1977a48dc057bd-969a5ff41ad9563474.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1924323512').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002116943754'))
...
auth_channel = environ.get('AUTH_CHANNEL', 'https://t.me/MJUniversal') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Professor:Hiihello07@cluster0.3asxv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mj_movie_bot07')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MJUniversal')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'mj_movie_bot07') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/MJPROFESSOR07Bot')
...
IMDB_TEMPLATE_TEXT = environ.get("IMDB_TEMPLATE_TEXT","default_template", f"{script.IMDBTEMPLATETEXT}")
